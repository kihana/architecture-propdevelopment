...
Роль для просмотра секретов: [здесь](Task4/secret-viewer-role.yaml)
Роль для чтения: [здесь](Task4/viewer-role.yaml)
Роль для полного доступа: [здесь](admin-role.yaml)

Биндинги для просмотра секретов: [здесь](Task4/secret-viewer-bindings.yaml)
Биндинги для чтения: [здесь](Task4/viewer-bindings.yaml)
Биндинги для полного доступа: [здесь](Task4/admin-bindings.yaml)
